...
namespace ParkingSystem.Admin
{
    public partial class frmBaiXe : Form
    {
        ...
        private void frmBaiXe_Load(object sender, EventArgs e)
        {
            ...
            dataGridView1.Columns[1].HeaderText = "Tên bãi xe";
            dataGridView1.Columns[2].HeaderText = "Địa chỉ";
            dataGridView1.Columns[3].HeaderText = "Sức chứa";
        ...
        private void buttonThem_Click_1(object sender, EventArgs e)
        {
            try
            {
                if (verif())
                {
                    ...
                    {
                        MessageBox.Show("Thêm bãi xe thành công!", "Thêm bãi xe", MessageBoxButtons.OK, MessageBoxIcon.Information);
            ...
            {
                MessageBox.Show(ex.Message, "Thêm bãi xe", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
